...
namespace InspectionAPI.Controllers
{
    ...
    {
        private readonly InspectionDataContext _context;

        public InspectionTypesController(InspectionDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<InspectionType>> PostInspectionType(InspectionType inspectionType)
        {
          if (_context.InspectionTypes == null)
          {
              return Problem("Entity set 'InspectionDataContext.InspectionTypes'  is null.");
          }
