...
namespace InspectionAPI.Migrations
{
    ...
    [Migration("20220616092640_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InspectionModel.Models.Inspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspectionModel.Models.InspectionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspectionModel.Models.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspectionModel.Models.Inspection", b =>
                {
                    b.HasOne("InspectionModel.Models.InspectionType", "InspectionType")
                        .WithMany()
